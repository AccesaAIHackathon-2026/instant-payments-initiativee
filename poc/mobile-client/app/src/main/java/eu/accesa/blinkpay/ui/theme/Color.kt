...
private val BlinkSecondary = Color(0xFF00897B)           // darkened from #00C9A7 for WCAG AA contrast
private val BlinkOnSecondary = Color.White
private val BlinkSecondaryContainer = Color(0xFFB2DFDB)  // slightly deeper teal tint
private val BlinkOnSecondaryContainer = Color(0xFF00382E)
private val BlinkBackground = Color(0xFFF7F9FC)          // cool-white with slight blue tint
...
private val BlinkSurfaceVariant = Color(0xFFE8EDF5)      // subtle blue-grey for action cards
private val BlinkOnSurfaceVariant = Color(0xFF44474F)
private val BlinkOutline = Color(0xFF74777F)
private val BlinkOutlineVariant = Color(0xFFC4C7CF)
...
val BlinkPayLightColors = lightColorScheme(
    ...
    surfaceVariant = BlinkSurfaceVariant,
    onSurfaceVariant = BlinkOnSurfaceVariant,
    outline = BlinkOutline,
    outlineVariant = BlinkOutlineVariant,
    error = BlinkError,
