      ...
      <div className="flow-diagram">
        <svg viewBox="0 0 1060 520" xmlns="http://www.w3.org/2000/svg">
          ...
          <path
            ...
            stroke={hlTransfer ? '#0097B9' : currentStep > 3 ? '#059669' : '#94A3B8'}
          />
          <text
          ...
          <path
            ...
            stroke={currentStep === 4 ? '#059669' : '#94A3B8'}
          />
          <text
            x={870} y={185}
          ...
          <rect
            ...
            stroke={hlBank ? '#6366F1' : '#94A3B8'}
            strokeWidth={hlBank ? 2 : 1}
          />
          <text x={bank.x + 16} y={bank.y + 24} fill="#4338CA" fontSize={15} fontWeight={600}>
            🏦 Bank
          </text>
          ...
          <rect
            ...
            fill={hlCustAcct ? '#2563EB' : '#E2E8F0'}
            opacity={hlCustAcct ? 0.9 : 0.7}
            stroke={hlCustAcct ? '#60A5FA' : '#94A3B8'}
            strokeWidth={hlCustAcct ? 2 : 1}
          />
          <text x={custAcct.x + 14} y={custAcct.y + 28} fill="#E2E8F0" fontSize={13} fontWeight={600}>
            👤 Alice — Customer
          </text>
          <text x={custAcct.x + 14} y={custAcct.y + 50} fill="#64748B" fontSize={11}>
            DE89…013001
          </text>
          ...
          <rect
            ...
            fill={hlRetAcct ? '#059669' : '#E2E8F0'}
            opacity={hlRetAcct ? 0.9 : 0.7}
            stroke={hlRetAcct ? '#34D399' : '#94A3B8'}
            strokeWidth={hlRetAcct ? 2 : 1}
          />
          <text x={retAcct.x + 14} y={retAcct.y + 28} fill="#E2E8F0" fontSize={13} fontWeight={600}>
            🏪 Retail Store GmbH
          </text>
          <text x={retAcct.x + 14} y={retAcct.y + 50} fill="#64748B" fontSize={11}>
            DE89…013099
          </text>
