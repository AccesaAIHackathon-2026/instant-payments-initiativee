    ...
    <div className="slide-flow">
      ...
      <div className="flow-diagram">
        <svg viewBox="0 0 1060 460" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect x={infra.x + 30} y={infra.y + 16} width={180} height={56} rx={10} fill="#6366F1" opacity={0.1} stroke="#475569" strokeWidth={1} />
          <text x={infra.x + 48} y={infra.y + 42} fill="#546E7A" fontSize={12} fontWeight={600} opacity={0.4}>
            🏦 Bank
          </text>
          <text x={infra.x + 48} y={infra.y + 58} fill="#546E7A" fontSize={10} opacity={0.3}>
            Not involved
          </text>

          {/* FIPS sub-box inside infra */}
          <rect x={infra.x + 240} y={infra.y + 16} width={470} height={56} rx={10} fill="#D97706" opacity={0.06} stroke="#475569" strokeWidth={1} />
          <text x={infra.x + 475} y={infra.y + 42} textAnchor="middle" fill="#546E7A" fontSize={12} fontWeight={600} opacity={0.4}>
            🔄 FIPS — Settlement Infrastructure
          </text>
          <text x={infra.x + 475} y={infra.y + 58} textAnchor="middle" fill="#546E7A" fontSize={10} opacity={0.3}>
            Not involved — transfer is peer-to-peer
          </text>

          {/* X marks — dashed lines from devices down to infra, crossed out */}
          <line x1={device1.x + device1.w / 2} y1={device1.y + device1.h + 60} x2={infra.x + 120} y2={infra.y} stroke="#546E7A" strokeWidth={1} strokeDasharray="4 4" opacity={0.15} />
          <line x1={device2.x + device2.w / 2} y1={device2.y + device2.h + 60} x2={infra.x + infra.w - 120} y2={infra.y} stroke="#546E7A" strokeWidth={1} strokeDasharray="4 4" opacity={0.15} />
