      ...
      <div className="flow-diagram">
        <svg viewBox="0 0 1060 510" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect
            ...
            fill={isHl('fips') ? '#D97706' : '#1E293B'}
            opacity={isHl('fips') ? 0.25 : 0.15}
            stroke={isHl('fips') ? '#F59E0B' : '#475569'}
          ...
          <text x={fips.x + fips.w / 2} y={fips.y + 58} textAnchor="middle" fill="#94A3B8" fontSize={12}>
          ...
          <line
            ...
            stroke={currentStep >= 2 ? (currentStep === 2 ? '#0097B9' : '#059669') : '#334155'}
          ...
          <line
            ...
            stroke={currentStep >= 3 ? (currentStep === 3 ? '#0097B9' : '#059669') : '#334155'}
          ...
          <path
            ...
            stroke={currentStep >= 4 ? (currentStep === 4 ? '#0097B9' : '#059669') : '#546E7A'}
          />
          {currentStep >= 4 && (
          ...
          <g className={`flow-node ${isHl('bankA') ? 'highlight' : ''}`} transform={`translate(${bankA.x}, ${bankA.y})`}>
            ...
            <text x={52} y={54} fill="#C7D2FE" fontSize={11}>Payer PSP</text>
            <text x={52} y={72} fill="#94A3B8" fontSize={10}>Alice — DE89…013001</text>
          </g>
          ...
          <g className={`flow-node ${isHl('bankB') ? 'highlight' : ''}`} transform={`translate(${bankB.x}, ${bankB.y})`}>
            ...
            <text x={52} y={54} fill="#C7D2FE" fontSize={11}>Payee PSP</text>
            <text x={52} y={72} fill="#94A3B8" fontSize={10}>Retail Store — DE89…013099</text>
          </g>
